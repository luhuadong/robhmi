...
TARGET = ResourceManage
TEMPLATE = lib
CONFIG += staticlib

SOURCES += ResourceManage.cpp \
    ResourceManageInit.cpp \
    ResourceManageSlot.cpp \
    ResourceManageAttr.cpp

HEADERS += ResourceManage.h \

FORMS += ResourceManage.ui \
